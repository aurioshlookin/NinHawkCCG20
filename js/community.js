...
window.getUserMedals = (inventory) => {
  ...
  // Adiciona a shuriken correspondente se a coleção daquele Tier estiver completa
  ...
  // Shuriken Suprema para o Álbum Inteiro 100% completo
